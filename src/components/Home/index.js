...
class Home extends React.Component {
  ...
  render() {
    ...
    const expiring =
      data1 &&
      data1.filter(record => isWithinDays(record.expiration, this.state.days));
    return (
      <Grid style={styles.center}>
        ...
        <Grid item xs={6}>
          <Paper style={styles.paper}>
            <FilteredChart
              query={DataMap.saas.query.allBasic}
        ...
        <Grid item xs={6}>
          <Paper style={styles.paper}>
            <Grid
              container
              style={{ maxWidth: "600px", alignItems: "flex-start" }}
              spacing={24}
            >
              <Grid item xs={9}>
                <Typography
                    ...
                    <ListItem>
                      ...
                      <ListItemText
                        ...
                        primary={
                          entry.name +
                          " expires " +
                          getWordsTillExpire(entry.expiration)
                        }
                      />
                    </ListItem>
                  );
